      ...
      <div className="max-w-7xl mx-auto grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-10">
        ...
        <div className="col-span-2 sm:col-span-1 md:col-span-1">
          ...
          <ul className="space-y-2 mt-2 text-sm">
            <li className="flex items-center gap-2">🛈 Help center</li>
            <li className="flex items-center gap-2">💬 Chat with us</li>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-center">
          ...
          <div className="flex gap-3">
            ...
            <a href="#" aria-label="Twitter">
              <svg className="w-4 h-4 hover:fill-black" fill="currentColor" viewBox="0 0 24 24">
                <path d="M22.46 6c-.77.35-1.6.58-2.46.69a4.27 4.27 0 0 0 1.88-2.37 8.47 8.47 0 0 1-2.7 1.03 4.22 4.22 0 0 0-7.26 3.85 11.96 11.96 0 0 1-8.76-4.63 4.23 4.23 0 0 0 1.31 5.63 4.2 4.2 0 0 1-1.91-.53v.05a4.23 4.23 0 0 0 3.39 4.14 4.3 4.3 0 0 1-1.9.07 4.23 4.23 0 0 0 3.95 2.93A8.49 8.49 0 0 1 2 19.54a12 12 0 0 0 6.29 1.84c7.55 0 11.69-6.26 11.69-11.7 0-.18-.01-.36-.02-.54A8.18 8.18 0 0 0 22.46 6z" />
              </svg>
            </a>
            {/* Instagram */}
